  ...
  const displayHow = (des: string) => {
    return (
      <div className="flex w-full flex-col justify-between">
        ...
        <p className="mt-[10px] mb-[20px] text-[20px] font-thin sm:mb-[10px] sm:text-[23px] md:mt-0 md:text-[14px] md:text-[#fff]/90">
          {des}
        </p>
        <div></div>
      </div>
    ...
    <section className="g-page-height flex w-full justify-center">
      <div className="g-body-container justify-start md:justify-center">
        <div className="flex max-w-[594px] flex-col md:w-[585px]">
          ...
          <h2 className="mb-[26px] mt-[22px] max-w-[382px] pl-[20px] text-[20px] sm:pl-[66px] sm:text-[31px] md:mb-[56px] md:mt-[30px] md:w-auto md:text-[14px]">
